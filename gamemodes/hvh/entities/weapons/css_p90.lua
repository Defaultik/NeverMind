...
SWEP.Purpose			= "It appears that this gun is also in Fortnite...\nBut I don't play Fortnite :P"
SWEP.PrintName			= "P90"
SWEP.Slot				= 2
SWEP.SlotPos			= 3
...
local ground = self.Owner:GetGroundEntity()
		if self.Owner:KeyDown( IN_FORWARD ) and !self.Owner:KeyDown( IN_DUCK ) and (ground:IsWorld() or ground:IsWorld()) then
			...
			self.Primary.Cone = 7.3
			else
			self.Primary.Cone = 5.3
							end
							end
							end
							end
